...
// Passenger
// Passenger safety agent providing ETA + emergency assistance

export default function GapPassenger() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-passenger', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Passenger</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Passenger safety agent providing ETA + emergency assistance</p>
