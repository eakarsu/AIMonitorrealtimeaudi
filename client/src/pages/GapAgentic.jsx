...
// Agentic
// Agentic safety coach delivering personalized live guidance to drivers
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic safety coach delivering personalized live guidance to drivers</p>
