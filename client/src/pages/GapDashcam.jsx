...
// Dashcam
// Dashcam video ingest pipeline

export default function GapDashcam() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-dashcam', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Dashcam</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Dashcam video ingest pipeline</p>
