...
// Driver
// Driver coaching delivery UI (automated safety training)

export default function GapDriver() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-driver', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Driver</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Driver coaching delivery UI (automated safety training)</p>
