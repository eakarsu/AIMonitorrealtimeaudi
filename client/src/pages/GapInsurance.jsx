...
// Insurance
// Insurance risk orchestration with dynamic premium recommendations
...
export default function GapInsurance() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-insurance', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Insurance</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Insurance risk orchestration with dynamic premium recommendations</p>
