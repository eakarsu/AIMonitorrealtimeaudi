...
// Autonomous
// Autonomous emergency response with streaming incident detection
...
export default function GapAutonomous() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Autonomous emergency response with streaming incident detection</p>
